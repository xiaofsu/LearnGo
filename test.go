...
func main() {
	queryWords := flag.String("kw","麻生希,桃谷绘里香,大桥未久,早乙女露依,橘梨纱,美竹铃,天海翼,泷泽萝拉,樱井莉亚,铃原爱蜜莉", "the keyword to search")
	//queryWords := flag.String("kw","天海翼", "the keyword to search")
	flag.Parse()
	if queryWords == nil {
		flag.Usage()
		return
